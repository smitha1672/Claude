...
Usage:
  /ext-iot-firefly-worktree-mirror <remote-branch> [jira-id]
...
Examples:
  /ext-iot-firefly-worktree-mirror feature/IOT-456-fix-parser
    → /home/smith/workspace/code_worktree/mirror/IOT-456

  /ext-iot-firefly-worktree-mirror bugfix/FIRE-789-fix-issue
    → /home/smith/workspace/code_worktree/mirror/FIRE-789

  /ext-iot-firefly-worktree-mirror IOT-123-my-feature
    → /home/smith/workspace/code_worktree/mirror/IOT-123

  /ext-iot-firefly-worktree-mirror pmx_FF_v9.0.0 AGWW-63
